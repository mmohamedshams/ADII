...
<div class="container">
    ...
    <table>
        <div>
        <a href="admin_moany.php"> <i class="fa-solid fa-plus"></i>Add Invoice</a>
        </div>
        <thead>
            <tr>
                <th>text_value</th>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    <a href='view_moany_admin.php?id=" . $row["id"] . "' target='_blank'>
...
function confirmDelete(recordId) {
    ...
    if (result) {
        ...
        window.location.href = 'delete_moany_admin.php?id=' + recordId;
    } else {
