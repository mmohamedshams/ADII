...
<div class="content-box">
    <form method="post" action="">
        <label for="text">Exam text :</label>
        ...
        <label for="selected_code">Choose the random code :</label>
    ...
    ?>
        ...
        <label for="teacher_name" style="display:none;">Teatcher Name :</label>
<input type="text" name="teacher_name" value="<?php echo htmlspecialchars($full_name); ?>" style="display:none;">

<label for="user_code" style="display:none;">Code  :</label>
<input type="text" name="user_code" value="<?php echo htmlspecialchars($random_code); ?>" style="display:none;">


<div style="display:flex;">
        <button id="toggle-content-box" class="add_button">Add Exam</button>
        <a href="admin_exam.php"><div class="back">Back</div></a>
        </div>
    </form>
</div>  
</div>      
