...
$content_sql = "SELECT * FROM content WHERE random_code = '$random_code'";
...
if ($content_result->num_rows == 1) {
    ...
    $content_link = $content_row['link'];
    $content_start_time = $content_row['start_time'];
    $content_end_time = $content_row['end_time'];

    $startDateTime = new DateTime($content_start_time);
    $endDateTime = new DateTime($content_end_time);
    $interval = $startDateTime->diff($endDateTime);
    $time_difference = $interval->format('%H:%I');
    ...
    <h1>الامتحانات</h1>
        <table>
            ...
            <tr>
                <td><a href="<?php echo $content_link; ?>"><?php echo $content_text; ?></a></td>
                <td><?php echo $startDateTime->format('Y / m / d   __ H:i'); ?></td>
