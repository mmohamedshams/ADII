...
<div class="container">
        ...
        <form action="upload_table_teacher.php" method="post" enctype="multipart/form-data">
        <table>
        ...
        <input type="text" name="username" id="username" readonly>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="back" href="admin_teacher_detalis.php">Back</a>
                    </td>
                </tr>
            </table>
        </form>
