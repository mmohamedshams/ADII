...
<title>Teachers' schedules</title>
...
<div class="container">
    ...
    <table>
        <div>
        <a href="dashboard_Table_teacher.php"> <i class="fa-solid fa-plus"></i>Add Table</a>
        </div>
        <thead>
            <tr>
                <th>Teacher Name</th>
...
function confirmDelete(recordId) {
    ...
    if (result) {
        ...
        window.location.href = 'delete_teacher.php?id=' + recordId;
    } else {
