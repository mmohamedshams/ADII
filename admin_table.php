...
<div class="container">
        ...
        <form action="upload_table.php" method="post" enctype="multipart/form-data">
        <table>
    ...
    <td>
        <select name="code" id="code" onchange="updateUsername()">
            <?php
            $sql = "SELECT random_code , email, full_name FROM users WHERE role = 'student'";
            $result = $conn->query($sql);
        ...
        <input type="text" name="username" id="username" readonly>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="back" href="admin_stydent_detalis.php">Back</a>
                    </td>
                </tr>
            </table>
        </form>
