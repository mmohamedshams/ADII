...
<div class="container1">
                <a href="Teacher_table.php" class="box-table" >
                <img src="image/table.png" >
                    <p>الجداول</p>
                </a>
                <a href="Teacher_coursas.php" class="box-coursas" >
                <img src="image/training_1654193.png" >
                    <p>المحاضرات</p>
                </a>
                <a href="Teacher_moany.php" class="box-moany" >
                <img src="image/money-bag_1990406.png" >
                    <p>الراتب</p>
                </a>
                <a href="Teacher_exam.php" class="box-exam" >
                <img src="image\Exam-Cartoon-Transparent-Background.png" >
                    <p>الامتحانات</p>
                </a>
</div>
<div class="container2">
                <a href="Teacher_result.php" class="box-result" >
                <img src="image/5050958.png" >
                    <p>الدرجات</p>
                </a>
                
                <a href="Teacher_help.php" class="box-help" >
