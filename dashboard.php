...
<div class="container">
    ...
    <table>
        <div>
        <a href="add_account.php"> <i class="fa-solid fa-user-plus"></i> Add Person</a>
        </div>
        <thead>
            <tr>
                <th>email</th>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                        ...
                        <i class='fa-regular fa-trash-can' style='color:#E74C3C'></i></a></a>
                        <a href='random_code.php?code=" . $row["random_code"] . "'><i class='fa-solid fa-pen-to-square'></i></a></td>
                        </td>
                    </tr>";
                }
            } else {
